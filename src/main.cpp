...
int main(int argc, char* argv[]) {
    ...
    if (algo == "hs") {
        ...
        plot1(imagePrevRaw, u, v, 10, 20, savePath+"hs"); //TBD if needed add as arguments
        plot2(imagePrevRaw, u, v, 20, savePath+"hs"); //TBD if needed add as arguments
        ...
        plot1(imagePrevRaw, flow_parts[0], flow_parts[1], 10, 20, savePath+"fb"); //TBD if needed add as arguments
        plot2(imagePrevRaw, flow_parts[0], flow_parts[1], 20, savePath+"fb"); //TBD if needed add as arguments
